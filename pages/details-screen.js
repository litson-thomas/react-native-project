...
const DetailScreen = ({ navigation, route }) => {
  ...
  var isFavourite = favouriteProducts.includes(product.id)
    ? "heart"
    : "heart-o";
  ...
  const fetchFavourites = async () => {
    ...
    isFavourite = [...data.map((a) => a.product)].includes(product.id)
      ? "heart"
      : "heart-o";
        ...
        <View style={styles.detailsBox}>
          <View style={styles.detailWrapper}>
            ...
            <View style={styles.btncontainer}>
              ...
              <TouchableOpacity
                onPress={onFavourite.bind(this, product, isFavourite)}
              >
                <FontAwesome
                  name={isFavourite}
                  size={40}
